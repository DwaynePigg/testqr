...
RS_GEN_20 = [227, 213, 211, 174, 18, 70, 38, 238, 158, 126, 236,  85, 241, 193, 107, 46, 112, 222, 209, 56]
RS_GEN_7 = [127, 122, 154, 164, 11, 68, 117]


def get_ecc_bytes(data, n_ecc=7):
	ecc = [*data, *[0] * n_ecc]
	for i in range(len(data)):
		coef = ecc[i]
		if coef != 0:
			for j, g in enumerate(RS_GEN_7):
				ecc[i + j] ^= GF_EXP[(GF_LOG[coef] + GF_LOG[g]) % 255]
